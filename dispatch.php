...
<table style="width:60%;">
    <tbody>
        ...
        if(isset($_POST['submit'])){
            ...
            $projectQuery = "SELECT * FROM `tracking_details` WHERE `projectid` = '$projectname'";
        ...
        <tbody>
            ...
            while($projectRow = mysqli_fetch_assoc($projectResult)){
                ...
                $ItemCode = $projectRow['itemcode'];
                $SubItemId = $projectRow['subitemid'];
                ...
                <td>'.$ProjectId.'</td>
                <td>
                <button class="btn btn-primary" style="border:none;"><a href="trackingupdate.php? trackingid='.$ItemCode.' " class="text-light">'.$ItemCode.'</a></button>
