...
<h1>Report Submit</h1>
    <form action="">
        ...
        <input type="checkbox" name="report" id="">Employ Report<br><br>
        <input type="checkbox" name="report" id="">Eser Report<br><br>
        <input type="checkbox" name="report" id="">Admin Report<br><br>
        <input type="checkbox" name="report" id="">Default Report<br><br>
