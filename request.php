...
<center>
    <a href="separaterequest.php" >Add Item Request </a>
</center>
...
<?php
  ...
  $result = $conn->query($sql);
?>
<h1 style="text-align:center;">Inventory Request Details</h1>
<table>
    <thead>
        <tr>
            ...
            <th style="text-align:center;">Requested User Id</th>
            <th>Draft Edit</th>
        </tr>
    </thead>
    <tbody>
        <?php
            ...
            if($result){
                while($row = mysqli_fetch_assoc($result)){
                    ...
                    $requestedemployid = $row['Requestedempid'];
                    echo '<tr>
                   
                    <td>'.$projectdetails.'</td>

                    <td style="text-align:center;">'.$requestedemployid.'</td>
                    <td>
                    <button class="btn btn-primary"><a href="edit.php? editid='.$requestid.'" class="text-light">Edit</a></button>
